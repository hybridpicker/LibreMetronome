...
const PolyrhythmControls = ({
  ...
  // Available beat configurations for both circles
  const beatOptions = [2, 3, 4, 5, 6, 7, 8, 9];

  return (
    <div className="polyrhythm-controls">
      {/* Button controls for both circles */}
      <div className="polyrhythm-buttons-container">
      ...
      {/* Footer controls that always appear below both button sets */}
